      ...
      <div className="relative flex flex-col items-center gap-8 w-full max-w-sm px-6">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-bold text-foreground">Prognexa</h1>
        ...
        <div className="w-full rounded-xl border border-border bg-card p-8 shadow-xl">
          ...
          <p className="mt-4 text-center text-xs text-muted-foreground">
            Only authorised plant personnel can access this system.
          </p>
        </div>

        <p className="text-xs text-muted-foreground">
          © 2026 Prognexa — Predictive Maintenance Platform
        </p>
      </div>
    </div>
  )
